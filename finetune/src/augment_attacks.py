...
# Updated lists with attack vectors and ethical responses
...
# Use the attack vectors instead of distress messages
USER_DISTRESS_MESSAGES = USER_ATTACK_MESSAGES
ASSISTANT_ENCOURAGING_RESPONSES = ASSISTANT_ETHICAL_RESPONSES
...
def augment_conversation(prefix, conversation, output_str):
    """Augment conversation with attack/response exchanges"""
...
if __name__ == "__main__":
    process_dataset("dataset/data/processed/test_normal.jsonl", "dataset/data/processed/test_attack.jsonl")
    process_dataset("dataset/data/processed/train_normal.jsonl", "dataset/data/processed/train_attack.jsonl")
    process_dataset("dataset/data/processed/val_normal.jsonl", "dataset/data/processed/val_attack.jsonl")
